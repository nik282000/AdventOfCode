...
'''
Use Caching to save on CPU smoke
Starting at any given | point on the map, navigate downward until a ^ is reached
When encoutering a ^ split
Return the number of times the end was reached
